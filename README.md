...
## If trained from scratch: **IMPORTANT**
  ...
  Step 6: Choose your desired model by renaming them in the main_interface.py (#comments available in file to guide) **IMPORTANT**
